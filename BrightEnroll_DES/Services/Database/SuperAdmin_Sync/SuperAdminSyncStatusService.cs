...
// Service to track and expose SuperAdmin sync status to UI components
public interface ISuperAdminSyncStatusService
{
    bool IsOnline { get; }
    bool IsSyncing { get; }
    ...
    event EventHandler<SuperAdminSyncStatusChangedEventArgs> StatusChanged;
...
public class SuperAdminSyncStatusChangedEventArgs : EventArgs
{
...
public class SuperAdminSyncStatusService : ISuperAdminSyncStatusService
{
    ...
    public event EventHandler<SuperAdminSyncStatusChangedEventArgs>? StatusChanged;
    ...
    {
        var args = new SuperAdminSyncStatusChangedEventArgs
        {
            IsOnline = _isOnline,
